        ...
        <article className="post">
          ...
          <footer className="post__meta">
            <div className="container container--md">
              ...
              <time
                className="published"
                dateTime={moment(_.get(this.props, "page.frontmatter.date", null)).strftime(
                  "%Y-%m-%d %H:%M",
                )}
              >
                      ...
                      <div className="grid post-feed post-feed--col-two">
                        {curr_index !== 0 &&
                          (() => {
                            ...
                            return <BlogFeedItem {...this.props} post_page={prev_post} />
                          })()}
                        {curr_index < post_index_length &&
                          (() => {
                            let next_post = posts_sorted[next_index]
                            return <BlogFeedItem {...this.props} post_page={next_post} />
                          })()}
                      </div>
                    </div>
                  </nav>
